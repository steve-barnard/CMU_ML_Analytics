...
resid_hist
```
The initial residual plot histogram shows there are non-normal errors with the long tail.
...
mean((s.pred - y)^2)
```
Average Squared error of 32.4349

Again a decent improvement over the initial qqplot.

Overall, I feel this is a decent model given the data. X8's residuals are still a bit confusing and I'm not sure how to deal with them, I've attempted multiple transofrmations without any notable improvement and feel this may be that our model is missing a factor.

I wrote my markdown in this fashion so that you can attempt to see my thought process, and I understand normally, I could have just updated items and iterated using fewer lines of code.
